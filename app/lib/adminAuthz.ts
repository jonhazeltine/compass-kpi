...
export const ADMIN_ROUTES: AdminRouteDefinition[] = [
  ...
  },
  {
    ...
    description: 'Coach portal uploads shell with role-scoped boundaries and transition-host compatibility redirects.',
  },
  {
    key: 'coachingLibrary',
    label: 'Library',
    path: '/coach/library',
    requiredRoles: ['platform_admin', 'super_admin', 'coach', 'team_leader', 'challenge_sponsor'],
    description: 'Coach portal library shell for coaching, team leader, and sponsor scoped tools.',
  },
  {
    key: 'coachingJourneys',
    label: 'Journeys',
    path: '/coach/journeys',
    requiredRoles: ['platform_admin', 'super_admin', 'coach', 'team_leader'],
    description: 'Coach portal journeys shell for coach and team leader authored lesson paths and release readiness.',
  },
  {
    key: 'coachingCohorts',
    label: 'Cohorts',
    path: '/coach/cohorts',
    requiredRoles: ['platform_admin', 'super_admin', 'coach', 'team_leader', 'challenge_sponsor'],
    description: 'Coach portal cohorts shell for audience segmentation with scoped sponsor visibility.',
  },
  {
    ...
    path: '/coach/channels',
    requiredRoles: ['platform_admin', 'super_admin', 'coach', 'team_leader', 'challenge_sponsor'],
    description: 'Coach portal channels shell for scoped communication operations across all coaching personas.',
  },
  {
    key: 'coachingAudit',
