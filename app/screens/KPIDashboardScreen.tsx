...
function deriveChallengeScopedKpis(
...
const styles = StyleSheet.create({
  ...
  teamHealthMeterSummaryRow: {
    marginTop: 8,
    gap: 6,
  },
  teamHealthMeterSummaryText: {
    color: '#6d7789',
    fontSize: 11,
    fontWeight: '600',
  },
